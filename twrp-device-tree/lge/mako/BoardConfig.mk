...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 7176192 # This is the maximum known partition size, but it can be higher, so we just omit it
...
BOARD_RAMDISK_OFFSET := 0x01600000
